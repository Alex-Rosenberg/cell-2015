...
np.save('../results/N4_Motif_Effect_Sizes/A5SS/boot_strapped_effects_R1', effects_array)
np.save('../results/N4_Motif_Effect_Sizes/A5SS/mean_effects_sdpos_R1', effects_mean)
