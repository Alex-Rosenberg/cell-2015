...
seqs = pd.Series(A3SS_seqs).str.slice(0,25)
...
np.save('../results/N4_Motif_Effect_Sizes/A3SS/boot_strapped_effects_R1', effects_array)
np.save('../results/N4_Motif_Effect_Sizes/A3SS/mean_effects_sdpos_R1', effects_mean)
